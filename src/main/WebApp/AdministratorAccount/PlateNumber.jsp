...
layui.use(['table','laypage'], function(){
  ...
  table.render({
    elem: '#table'
    ,height: 'full-300'
    ,url: '/plateNumber/getallpsbypage'
...
//     ,page: {theme: '#c00',  limits:[5,10,25,50], groups:5, limit:25/* , curr:7 */, id: 'abc1'}
    ...
    ,cols: [[
      ...
      ,{field:'PlateNumber',templet:'#tpl_plateNumber_plateNumber',  title: '绑定车牌'}
		...
		if(layEvent === 'detail'){ //查看
			layerOut(layEvent, data.id);
		 	 ...
		 	 layer.confirm('真的删除行么', function(index){
				//向服务端发送删除指令
				$.post('/plateNumber/delplateNumber', {id:data.id}, function(data){
					var result;
