...
//     ,page: {theme: '#c00',  limits:[5,10,25,50], groups:5, limit:25/* , curr:7 */, id: 'abc1'}
    ...
    ,cols: [[
        ...
        ,{field:'feedbackCarOwnerId', templet:'#tpl_carOwnerUser_realName', title: '反馈车主id', width:200}
        ...
        ,{field:'sharingPlatformId', templet:'#tpl_sharingPlatform_parkingInfo_parkingName', title: '平台表id', sort: true, width:200}
...
//	 	var NewOfAdd, NewOfEdit;
	 	$.post('/feedbackanddispute/feedlayeroptions', {eventType:eventType, id:id}, function(form) {
	 		layer.open({
				type: 1,
				title: '停车位信息',
				content: form,
