...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/AdministratorAccount/css/global.css" media="all">
		<link rel="stylesheet" href="${pageContext.request.contextPath }/AdministratorAccount/plugins/font-awesome/css/font-awesome.min.css">
...
<!-- 						<li class="layui-nav-item">
			...
			<div class="layui-footer footer footer-demo" id="admin-footer">
				<div class="layui-main">
					<p>2018 &copy;
						<a href="http://m.zhengjinfan.cn/">zhenhaoting.cn/</a> LGPL license
					</p>
				</div>
			</div>
...
layui.use(['layer','laypage'], function(){
  ...
  if(window.WebSocket){  
      socket = new WebSocket("ws://49091438.nat123.cc");  
        
      socket.onmessage = function(event){             
//             appendln("receive:" + event.data);          
            layer.msg(event.data, {time: 8000, offset: 'r'});
      };
