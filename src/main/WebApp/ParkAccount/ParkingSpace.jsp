...
<%-- 	 <iframe src="${pageContext.request.contextPath }/ParkAccount/WebIM/index.jsp"  height="500" width="370" style="position: absolute; top: 530px; left: 1200px; z-index: 0px;"></iframe> --%>
 <div id="psPage"></div> 
...
layui.use(['table','laypage'], function(){
  ...
  table.render({
    elem: '#table'
    ,height: 'full-300'
    ,url: '/parkingspace/getallpsbypage'
    ,where:{
...
//     ,page: {theme: '#c00',  limits:[5,10,25,50], groups:5, limit:25/* , curr:7 */, id: 'abc1'}
    ...
    ,cols: [[
      ...
      ,{field:'parkingSpaceNumber', title: '停车位编号'}
      ,{field:'areaNumberId', templet:'#tpl_parkingDictionary_areaName', title: '区域编号名称', sort: true}
      ,{field:'parkingSpaceStatusId', templet:'#tpl_parkingSpaceStatus_parkingSpaceStatusName', title: '停车位状态'}
      ,{field:'parkingSpaceOwnerId', templet:'#tpl_carOwnerUser_userName', title: '所有者用户名'}
      ,{field:'parkingId', templet:'#tpl_parkingInfo_parkingName', title: '停车场名称', sort: true}
...
function layerOut(eventType, id, obj){//obj是传进来，给修改成功后：要更新的行Dom对象
	...
	layui.use(['layer', 'form'], function(){
		var $ = layui.$;
	 	...
	 	$.get('/parkingspace/layeroptions', {eventType:eventType, id:id}, function(form) {
	 		layer.open({
				type: 1,
				title: '停车位信息',
				content: form,
...
<!-- 复杂表头属性绑定 -->
 <script type="text/html" id="tpl_parkingDictionary_areaName">
	{{# if(d.parkingDictionary != null){ }}
		{{d.parkingDictionary.areaName}}
	{{# } }}
</script>
 <script type="text/html" id="tpl_parkingSpaceStatus_parkingSpaceStatusName">
	{{# if(d.parkingSpaceStatus != null){ }}
		{{d.parkingSpaceStatus.parkingSpaceStatusName}}
	{{# } }}
</script>
