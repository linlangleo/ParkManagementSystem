...
<meta http-equiv="Content-Type" content="text/html; utf-8">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/ParkAccount/WebIM/font_Icon/iconfont.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/ParkAccount/WebIM/css/chat.css">
			...
			$("#chatBox-content-demo").append("<div class='clearfloat'>"+
      			  ...
      			  "<div class='left'>"+
    			     "<div class='chat-avatars'><img src='img/icon02.png' alt='头像'/></div>"+
       			     "<div class='chat-message'>"+event.data+"</div>"+
      			  "</div>"+
   				 "</div>");
